...
namespace Cathy.Oracle
{
    public static class DbOperExtend
    {
        ...
        {
            string strSql = @"select f_create_id() as Id from dual";
            return OracleDbOper.ExecuteScalar(strSql,OracleDbOper.CreateConn());
        }
        ...
        {
            string strSql = @"select f_create_id() as Id from dual";
            return OracleDbOper.ExecuteScalar(strSql, OracleDbOper.CreateConn(conn));
        }
        ...
        {
            OracleEntityOper seo = new OracleEntityOper();
        ...
        /// <returns>影响行数</returns>
        public static int Insert<T>(this T entity,OracleConnection conn, OracleTransaction sqlTran) where T : new()
        {
            OracleEntityOper seo = new OracleEntityOper();
        ...
        public static int Update<T>(this T entity, string strWhere, params object[] para)
        {
            ...
            for (int i = 0; i < mc.Count; i++)
            {
                ...
                paraList.Add(new OracleParameter(paraName, para[i]));
            }
            #endregion
            OracleEntityOper seo = new OracleEntityOper();
            string strConn = "";
        ...
        /// <param name="para">条件值</param>
        /// <returns>影响行数</returns>
        public static int Update<T>(this T entity, string strWhere, OracleConnection conn, OracleTransaction sqlTran, params object[] para)
        {
            List<OracleParameter> paraList = new List<OracleParameter>();
            #region where条件参数
            MatchCollection mc = Regex.Matches(strWhere, @"\{.+?\}");
        ...
        /// <param name="para">条件值</param>
        /// <returns>影响行数</returns>
        public static int Delete<T>(this T entity, string strWhere, OracleConnection conn, OracleTransaction sqlTran, params object[] para)
        {
            List<OracleParameter> paraList = new List<OracleParameter>();
            #region where条件参数
            MatchCollection mc = Regex.Matches(strWhere, @"\{.+?\}");
        ...
        public static bool Select<T>(this T entity, string fields, string strWhere, params object[] para)
        {
            ...
            DataTable dt = OracleDbOper.DataSet(strSql, OracleDbOper.CreateConn(strConn), paraList);
            if (dt.Rows.Count > 0)
            {
        ...
        public static string Max<T>(this T entity, string field, string strWhere, params object[] para)
        {
            ...
            string strSql = string.Format("select decode(max({0}),null,0,max({0})) from {1} where {2}", field, t.Name, strWhere0);
            string maxValue = OracleDbOper.ExecuteScalar(strSql, OracleDbOper.CreateConn(strConn), paraList);
            return maxValue;
        }
        ...
        public static string Max<T>(this T entity, string field)
        {
            ...
            string strSql = string.Format("select decode(max({0}),null,0,max({0})) from {1}", field, t.Name);
            string maxValue = OracleDbOper.ExecuteScalar(strSql, OracleDbOper.CreateConn(strConn), null);
            return maxValue;
        }
